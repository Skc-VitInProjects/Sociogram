    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
       ...
       <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
                   ...
                   ${msg.senderId !== authUser._id && 'flex-row-reverse'}`}>
                      {msg.image ? (
                         ...
                         <p className= {`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 
                           break-all bg-[#212121] text-white
         ...
         <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
            ...
            <div className='flex-2 flex items-center bg-[#535353] px-3 rounded-full'>
     ...
     <div className='flex flex-col items-center justify-center gap-2 text-gray-500  max-md:hidden'>
         ...
         <p className='text-lg font-medium text-white'>Explore , Connect and Chat</p>
     </div>
  )
}
